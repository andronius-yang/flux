...
## v3 delta (2026-09-17; provisional lane, see README.md)

- §2.1: eight bars — position 7 = **COMET+EPLB** (`row_id comet_eplb`,
  legend "COMET+EPLB"), Ours moves to position 8. `LEGEND_NCOL` 8.
- §5: color 7 `#7a3b7a` deep plum, re-validated (adjacent CVD 10.7,
  normal 17.2); §4 hatch `++`. Everything else unchanged (REV 3.1).
- Data: `ROW_SOURCE` knob + `VARIANTS` render the same-binary COMET anchor
  twin (`main_perf_v3_samebinary`).
