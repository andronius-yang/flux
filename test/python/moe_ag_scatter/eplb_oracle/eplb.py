# Vendored VERBATIM from deepseek-ai/EPLB @ d52c72d5b2f2fb4c41afbf8eb21366820239913d
# (MIT license, see LICENSE in this directory; workspace checkout:
# workspace/changchen/andrewy/EPLB). This file IS the algorithm under test for
# the eplb static-placement arm -- do not edit. The flux-side plan builder
# (python/flux/testing/eplb_semantics.py) consumes rebalance_experts() and is
# tested against it in test_eplb_planner.py.
