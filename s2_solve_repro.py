...
W, L, G, K, nlp = 8, 4, 128, 8, 16
tk = load_routing_file("/pscratch/sd/y/yufeid/workspace/andrewy/a2av_test_matrices/generated/w8x4_trace-9b63e8_b8_k8_id001.routing.txt", G, K).view(W, -1, K).long().cuda()
oc = load_routing_file("/pscratch/sd/y/yufeid/workspace/andrewy/a2av_test_matrices/generated/w8x4_trace-9b63e8_b8_k8_id001.oracle_routing.txt", G, K).view(W, -1, K).long().cuda()
